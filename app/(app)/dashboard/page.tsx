...
export default async function DashboardPage() {
  ...
  const stats = {
    ...
    totalDepositado: statsData?.reduce((s: number, r: any) => s + (r.total_depositado || 0), 0) ?? 0,
    totalRetirado: statsData?.reduce((s: number, r: any) => s + (r.total_retirado || 0), 0) ?? 0,
    gananciaCasino: statsData?.reduce((s: number, r: any) => s + (r.ganancia_casino || 0), 0) ?? 0,
